...
{user_id: seedUser1.id, video_id: demoVideo1.id, body: "The wind-shak'd surge, with high and monstrous main, Seems to cast water on the burning Bear, And quench the guards of the ever-fixed pole."},
...
{user_id: seedUser2.id, video_id: demoVideo4.id, body: "2493/5000"},
